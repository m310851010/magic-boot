...
CREATE TABLE `sys_login_log`  (
  ...
  `create_date` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 399 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_menu` VALUES ('06b8a427e4cd4c1ba11752070f565f20', 'b1851d1b13594e71840103c11a37a669', 'People', '', '用户管理', '/system/user/user-list', '', 50, '', '0', 0, NULL, NULL, '1', '2023-06-25 20:25:26', 1, 1);
...
INSERT INTO `sys_menu` VALUES ('10fc3bdde0c642aea2af34d281a49cf9', 'b1851d1b13594e71840103c11a37a669', 'home', '', '测试数据', '/system/test/test-list', '', 100, 'data-test-list', '0', 0, '1', '2022-01-16 13:43:03', '1', '2023-05-31 15:28:41', 1, 1);
...
INSERT INTO `sys_menu` VALUES ('39be13ef6f0745568c80bf35202ddb2b', 'b1851d1b13594e71840103c11a37a669', 'Menu', '', '菜单管理', '/system/menu/menu-list', '', 10, '', '0', 0, NULL, NULL, '1', '2023-06-25 20:10:13', 1, 1);
...
INSERT INTO `sys_menu` VALUES ('4fc65edbe0544c369b58fdfed1523537', '4a57f57fc7324c94b6390f1a2dd1f49a', 'oper-log', '', '操作日志', '/system/monitor/oper-log', '', 10, '', '0', 0, '1', '2022-03-05 17:24:45', '1', '2023-06-14 11:08:49', 1, 1);
...
INSERT INTO `sys_menu` VALUES ('6f3594d0-5445-41e1-a13c-890a57485036', 'b1851d1b13594e71840103c11a37a669', 'Organization12Filled', '', '组织机构', '/system/office/office-list', '', 20, '', '0', 0, '1', '2021-04-22 20:40:14', '1', '2023-06-25 20:12:59', 1, 1);
...
INSERT INTO `sys_menu` VALUES ('7ad229f12c8f4b57bbb9349e2ffd8932', 'b1851d1b13594e71840103c11a37a669', 'ContentSettings24Filled', '', '配置中心', '/system/configure/configure-list', '', 110, '', '0', 0, '1', '2022-05-21 18:32:26', '1', '2023-06-25 20:27:15', 1, 1);
...
INSERT INTO `sys_menu` VALUES ('8009eed4f46141e3aca939490d68786a', 'b1851d1b13594e71840103c11a37a669', '', '', '区域管理', '/system/area', '', 30, '', '0', 0, '1', '2019-11-15 10:23:07', '1', '2023-05-31 15:28:31', 0, 0);
...
INSERT INTO `sys_menu` VALUES ('8e9455740091486c914495cfb0c7faa5', 'b1851d1b13594e71840103c11a37a669', 'Accessibility', '', '角色管理', '/system/role/role-list', '', 40, '', '0', 0, NULL, NULL, '1', '2023-06-25 20:25:22', 1, 1);
...
INSERT INTO `sys_menu` VALUES ('c5f407478c4e4c9cbcdbee6389d2c909', 'b1851d1b13594e71840103c11a37a669', 'BookLetter24Filled', '', '数据字典', '/system/dict/dict-list', '', 60, '', '0', 0, '1', '2019-11-15 10:22:28', '1', '2023-06-25 20:26:35', 1, 1);
...
CREATE TABLE `sys_oper_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 68845 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '操作日志' ROW_FORMAT = COMPACT;
